...
- **Builder:** this repository is the proof — 168 app files, 1,829 tests, built app, a Swarm spec library, and a 243-app competitive dossier. The product is not a mockup; the demo is scripted against verified code.

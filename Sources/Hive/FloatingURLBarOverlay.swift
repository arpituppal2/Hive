    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 16) {
                ...
                // Zen glass pill (spec §4): 50px radius, 28px tall — the
                // floating omnibox shape from zen-omnibox.css.
                .frame(height: HiveDesign.Zen.omniboxHeight)
                .frame(maxWidth: 520)
                .background(
            ...
            .hiveTopEntrance(reduceMotion: reduceMotion)
        }
        .animation(reduceMotion ? nil : HiveDesign.Animation.entrance, value: appearID)
        .onAppear {

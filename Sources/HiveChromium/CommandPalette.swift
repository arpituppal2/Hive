...
struct PaletteCommand: Identifiable {
    ...
    let keywords: [String]
    let shortcut: String?
    let action: (ChromiumBrowserState) -> Void
    ...
    init(
        ...
        keywords: [String],
        shortcut: String?,
        action: @escaping (ChromiumBrowserState) -> Void
    ) {
        self.title = title
    ...
    static func allCommands(in state: ChromiumBrowserState) -> [PaletteCommand] {
        ...
        let panels: [(title: String, subtitle: String, icon: String, keywords: [String], shortcut: String?, open: (ChromiumBrowserState) -> Void)] = [

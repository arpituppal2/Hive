...
struct GeminiSidePanel: View {
    ...
    private var contextModeControl: some View {
        Menu {
            ForEach(ChromiumBrowserState.ContextMode.allCases) { mode in
                Button {
    ...
    private func tabPill(_ tab: ChromiumBrowserState.Tab) -> some View {
    ...
    private func tabAutocompleteRow(_ tab: ChromiumBrowserState.Tab, index: Int) -> some View {
    ...
    private var matchingTabs: [ChromiumBrowserState.Tab] {
    ...
    private func insertTabReference(_ tab: ChromiumBrowserState.Tab) {

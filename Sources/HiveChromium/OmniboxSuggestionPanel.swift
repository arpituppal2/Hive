...
struct OmniboxSuggestionPanel: View {
    ...
    let query: String
    let onSubmit: (ChromiumBrowserState.OmniboxSuggestion) -> Void
    let onDismiss: () -> Void

    private var suggestions: [ChromiumBrowserState.OmniboxSuggestion] {
    ...
    private func icon(for kind: ChromiumBrowserState.OmniboxSuggestion.Kind) -> String {
        switch kind {
    ...
    private func color(for kind: ChromiumBrowserState.OmniboxSuggestion.Kind) -> Color {
        switch kind {
    ...
    private func kindLabel(_ kind: ChromiumBrowserState.OmniboxSuggestion.Kind) -> some View {
        Text(label(for: kind))
    ...
    private func label(for kind: ChromiumBrowserState.OmniboxSuggestion.Kind) -> String {
        switch kind {

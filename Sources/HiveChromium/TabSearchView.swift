...
struct TabSearchOverlay: View {
    ...
    fileprivate struct FlatEntry: Identifiable {
        ...
        let workspace: ChromiumBrowserState.Workspace
    ...
    private var groupedTabs: [(workspace: ChromiumBrowserState.Workspace, tabs: [ChromiumBrowserState.Tab])] {
    ...
    private func workspaceHeader(_ workspace: ChromiumBrowserState.Workspace) -> some View {
        HStack(spacing: 6) {
    ...
    private func matches(_ tab: ChromiumBrowserState.Tab) -> Bool {
    ...
    private func displayTitle(_ tab: ChromiumBrowserState.Tab) -> String {
    ...
    private func displayHost(_ tab: ChromiumBrowserState.Tab) -> String {
    ...
    private func select(_ tab: ChromiumBrowserState.Tab) {
